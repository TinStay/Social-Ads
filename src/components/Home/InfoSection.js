    ...
    return(
        <div className="info-section">
           ...
           <div className="row info-section-row">
               ...
               <div className="col-md-2 col-md-pull-5 text-center">
                   <div className="info-text-container">
                        <h2 className="info-text-container-heading">Fill a form and run your ads</h2>
                        <p  className="info-text-container-paragraph col-lg-12">Social Ads allows you to choose your target audience, your budget, in which country you want your advertisement to be run and many more.</p>
                   </div>
                   
                </div>
                {/* <div className="col-xl-3 col-xl-pull-6 text-center">
           ...
           <div className="row info-section-row">
               <div className="col-xl-6  text-center">
                   <div className="info-text-container">
                        ...
                        <p  className="info-text-container-paragraph col-lg-12">Running social ads on more than one social media platform is the key to a successful ad campaign. You can choose in which platforms below you want your ads to appear.</p>
